                ...
                <div className="about-modal__body">
                    <div className="about-modal__description">
                        ...
                        <div className="about-modal__text">
                            ...
                            <p>
                                Начиная с 2013 года начал заниматься веб-дизайном и разработал первые пару сайтов. Дальше стал освавиать языки программирования, такие как HTML, CSS и JavaScript, чтобы создавать более интерактивные и функциональные веб-сайты. Параллельно с веб-дизайном стал изучать 3D-разработку – изучал моделирование, текстурирование и анимацию.
                            </p>
                            <p>
