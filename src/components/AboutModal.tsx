                ...
                <div className="about-modal__body">
                    <div className="about-modal__description">
                        ...
                        <div className="about-modal__text">
                            ...
                            <p>
                                Начиная с 2013 года начал заниматься веб-дизайном и разработал первые пару сайтов. Дальше стал осваивать языки программирования, такие как HTML, CSS и JavaScript, чтобы создавать более интерактивные и функциональные веб-сайты. Параллельно с веб-дизайном стал изучать 3D-разработку – моделирование, текстурирование и анимацию.
                            </p>
                            <p>
                                В 2024 попробовал себя в разработке мобильного приложения с дополненной реальностью. Приступил к изучению языка программирования Kotlin и платформы Android для создания мобильных приложений. К тому же в приложении использовалась 3D-графика. Постепенно расширяя свои навыки и знания, я стал более универсальным дизайнером, с недавнего времени увлекся видеопроизводством и созданием видео.
                            </p>
                        </div>
                    </div>
